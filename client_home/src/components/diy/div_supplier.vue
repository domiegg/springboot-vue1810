<template>
	<div class="diy_details_box diy_div_supplier">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
								<button class="btn btn-primary details_btn" v-if="$check_action('/supplier/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
		...
		methods: {
			...
			change_collect() {
				...
				var query = {
					...
					source_id: this.obj["supplier_id"],
					user_id
				};
      ...
      check_collect() {
        ...
        var supplier_id = this.obj.supplier_id;
