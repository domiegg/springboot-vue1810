<template>
	<div class="diy_details_box diy_div_bidding_project">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
											<button class="btn btn-primary details_btn" v-if="$check_action('/tender_information/edit','add')" @click="to_form('/tender_information/edit')" > 投标 </button>
										</div>
						<!-- 富文本 -->
