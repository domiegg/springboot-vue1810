<template>
	<div class="diy_home diy_list diy_bidding_project" id="diy_bidding_project_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/bidding_project/details?bidding_project_id=' + o['bidding_project_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/bidding_project/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/bidding_project/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
			...
			<table class="diy_table">
				<tr class="diy_row">
						...
						招标封面
							...
							<th class="diy_title" v-if="$check_field('get','introduction_to_bidding')">
						招标简介
					</th>
					</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
						...
						<img class="diy_img" :src="o['tender_cover']" />
							...
							<td class="diy_field diy_text" v-if="$check_field('get','introduction_to_bidding')">
						<span>
							{{ o["introduction_to_bidding"] }}
						</span>
					</td>
					</tr>
			</table>
