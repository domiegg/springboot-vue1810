		...
		<el-form label-position="right" :model="query" class="form p_4" label-width="120">
			<el-row>
					...
					<el-form-item label="招标分类">
									<el-select v-model="query.bidding_classification">
					...
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/bidding_project/table','add') || $check_action('/bidding_project/view','add')" class="el-button el-button--default el-button--primary search_btn_add" to="./view?">添加
						</router-link>
            			<el-button v-if="user_group == '管理员' || $check_action('/bidding_project/table','del') || $check_action('/bidding_project/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			<el-table-column fixed type="selection" tooltip-effect="dark" width="55">
				...
				v-if="user_group == '管理员' || $check_field('get','responsible_unit')" min-width="200">
					...
					<el-table-column prop="work_address" @sort-change="$sortChange" label="单位地址"
				v-if="user_group == '管理员' || $check_field('get','work_address')" min-width="200">
					</el-table-column>
				...
				v-if="user_group == '管理员' || $check_field('get','tender_cover')" min-width="200">
					...
					<el-table-column prop="introduction_to_bidding" @sort-change="$sortChange" label="招标简介"
				v-if="user_group == '管理员' || $check_field('get','introduction_to_bidding')" min-width="200">
					</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/bidding_project/table','set') || $check_action('/bidding_project/view','set') || $check_action('/bidding_project/view','get') || $check_action('/投标/table','add') || $check_action('/投标/view','add')" >


				<template slot-scope="scope">
					<router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
					v-if="user_group == '管理员' || $check_action('/bidding_project/table','set') || $check_action('/bidding_project/view','set') || $check_action('/bidding_project/view','get')"
	...
	export default {
		...
		data() {
			return {
				...
				url_del: "~/api/bidding_project/del?",
