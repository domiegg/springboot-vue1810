		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="供应商家" prop="supplier">
												<el-input id="supplier" v-model="form_sub['supplier']" placeholder="请输入供应商家"
							  v-if="user_group === '管理员' || (form_sub['supplier_id'] && $check_field('set','supplier')) || (!form_sub['supplier_id'] && $check_field('add','supplier'))"></el-input>
					<div v-else-if="$check_field('get','supplier')">{{form_sub['supplier']}}</div>
											</el-form-item>
			</el-col>
				...
				<el-form-item label="公司地址" prop="company_address">
							  ...
							  v-if="user_group === '管理员' || (form_sub['supplier_id'] && $check_field('set','company_address')) || (!form_sub['supplier_id'] && $check_field('add','company_address'))"></el-input>
