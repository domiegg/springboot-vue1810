	...
	<el-menu class="side el-menu-vertical-demo" default-active="/" @open="handleOpen" @close="handleClose"
		...
		<el-submenu index="user"
			...
			<el-menu-item index="/user/table" v-show="user_group == '管理员'"><span>管理员</span></el-menu-item>
						<el-menu-item index="/supplier/table" v-show="user_group == '管理员' || $check_action('/supplier/table')"><span>供应商家</span></el-menu-item>
							<el-menu-item index="/responsible_unit/table" v-show="user_group == '管理员' || $check_action('/responsible_unit/table')"><span>责任单位</span></el-menu-item>
